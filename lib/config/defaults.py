...
# Model architecture.
_C.MODEL.ARCH = "r2plus1d"

# Model depth
_C.MODEL.DEPTH = 34

# Model name
_C.MODEL.MODEL_NAME = "r2plus1d"

# The number of classes to predict for the model.
_C.MODEL.NUM_CLASSES = 313

# Loss function.
_C.MODEL.LOSS_FUNC = "cross_entropy"

# Model architectures that has one single pathway.
_C.MODEL.SINGLE_PATHWAY_ARCH = ["i3d", "r3d", "r2plus1d", "ir_csn"]
