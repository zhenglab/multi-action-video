...
class TestMeter(object):
    ...
    def finalize_metrics(self, ks=(1, 5)):
        ...
        save_preds_labels(self.video_preds.cpu().numpy(),
...
#         aps = average_precision_score(labels, preds, average=None)
        ...
        for i in range(len(preds)):
            aps.append(average_precision_score(labels[i], preds[i], average='macro'))
    except ValueError:
        print(
...
def save_preds_labels(preds, labels):
    import pickle
    with open("preds.pkl", "wb") as preds_pkl:
        pickle.dump(preds, preds_pkl, protocol=4)
    with open("labels.pkl", "wb") as labels_pkl:
        pickle.dump(labels, labels_pkl, protocol=4)
